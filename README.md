# Tip Calculator
This is my first attempt at building a React Native app using [Create React Native App](https://github.com/react-community/create-react-native-app).
Published on [Expo](https://exp.host/@andresrodh/tipcalculator)
